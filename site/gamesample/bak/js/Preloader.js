...
Unnamegame.Preloader.prototype = {
    ...
    preload: function () {
        ...
        this.load.image('swordParticle', 'assets/images/sword-particle.png');
        ...
        this.load.spritesheet('eyes', 'assets/images/eye.png', 40, 48);
        ...
        this.load.image("Tiles", "assets/images/tiles.png", 16, 16);
        this.load.tilemap("map", "assets/level/sam..csv", null, Phaser.Tilemap.CSV);
    },
    create: function () {
